...
def concat_inputs(
    ...
    return torch.cat([states, mu, actions], dim=1)

def concat_inputs_without_mu(
    states: torch.Tensor,
    actions: torch.Tensor,
):
